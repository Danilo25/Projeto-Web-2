...
public class TagApiController {
    ...
    public ResponseEntity<List<TagResponse>> getTags(@Parameter(description = "Nome da etiqueta para busca (opcional)") @RequestParam(required = false) String name) {
        List<TagResponse> tags = this.tagService.getTags(name);
